...
const LoginForm = () => {
  return (
    <>
      <div className="_Loginform p-2  ">
        <div className="_login-with text-center">
          <div className="_social_media-login ">
            <h1>Sign in with</h1>
            <div className="flex flex-col gap-2 mt-2">
              <button type="button" className="mt-1 px-3 py-2 text-white bg-black border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1">
                {" "}
                Github
              </button>
              <button type="button" className="mt-1 px-3 py-2 text-white bg-red-500 border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1">
                {" "}
                Google
              </button>
              <p> or</p>
        ...
        <div>
          <label class="block">
                ...
                <button className=" mt-1 px-3 py-2 text-white bg-black border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"> Submit </button>
        </div>
      </div>
    </>
  );
